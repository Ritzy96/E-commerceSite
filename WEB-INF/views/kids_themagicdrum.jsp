...
<title>www.bookart.com/kids/the_magic_drum</title>
<meta charset="utf-8">
...
<p style="font-family: 'Nunito', sans-serif;color:blue"><a href="KidsPage"><u>Kids</u></a>>>The Magic Drum and other favorite Stories - Sudha Murthy</p>

<br>
    <br>
  
  <h2 style="font-family: 'Oleo Script Swash Caps', cursive;"> The Magic Drum and other favorite Stories by Sudha Murthy</h2>   
 
  <table>
  <tr>
  <td> 
   <img  src="http://onlinestore.dcbooks.com/uploaded_files/books/bk_9780143330066.jpg" style="width:240px;height:360px" />
  </td>
...
<br>
  ...
  <p><span style="font-size:36px;font-family: 'Nunito', sans-serif;">  Our Price:</span><span style="font-size: 36px;font-family: 'Peralta', cursive;">Rs.200</span></p>
 <p><span style="font-size:20px;font-family:'Nunito'">  List Price:</span><span style="font-size: 20px;font-family:'Nunito';text-decoration:line-through">Rs.250</span></p>
  ...
  <p><a href="KidsPage"><button type="button" class="btn btn-info btn-md">BACK</button></a></p>
  </div>
  </td>
  </tr>
  </table>
...
<br>
  ...
  <p style= "font-family: 'Nunito', sans-serif;" >In this collection of stories from Indian folklore, Sudha Murty re-tells them from her memory of her grandparents. She tells the story of the clever and haughty princess who will only marry the man who asks her a question she cannot answer. She also tells the stories of kings, misers, wise men and foolish boys in this collection of hilarious and instructive stories which she loved from her days as a young girl.</p>
     <br>
    <br>
