...
<title>www.bookart.com/non-fiction/sachin_tendulkar</title>
...
<p style="font-family: 'Nunito', sans-serif;color:blue"><a href="NonFictionPage"><u>Non-Fiction</u></a>>>Sachin Tendulkar-Playing it my Way</p>
 

   <br>
<br>
  
  <h2 style="font-family: 'Oleo Script Swash Caps', cursive;"> Sachin Tendulkar-Playing it my way. </h2>   
  
   <table>
  <tr>
  <td>
   <img  src="http://images.indianexpress.com/2014/09/jacket-image-large.jpg" style="width:240px;height:360px" />
  </td>
...
<br>
  ...
  <p><span style="font-size:36px;font-family: 'Nunito', sans-serif;">Our Price:</span><span style="font-size: 36px;font-family: 'Peralta', cursive;">Rs.499</span></p>
 <p><span style="font-size:20px;font-family:'Nunito'">List Price:</span><span style="font-size: 20px;font-family:'Nunito';text-decoration:line-through">Rs.899</span>
...
<br>
  ...
  <tr >
  <td>Author</td>
  <td>Sachin Tendulkar , Majumdar Boria </td>
  </tr>
  <tr>
  <td>Publishers</td>
