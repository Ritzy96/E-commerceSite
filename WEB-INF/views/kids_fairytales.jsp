...
<title>www.bookart.com/kids/my_jumbo_book_of_fairy_tales</title>
<meta charset="utf-8">
...
<p style="font-family: 'Nunito', sans-serif;color:blue"><a href="KidsPage"><u>Kids</u></a>>>My Jumbo Book of Fairy Tales</p>

 <br>
<br>
  
  <h2 style="font-family: 'Oleo Script Swash Caps', cursive;"> My Jumbo Book of Fairy Tales</h2>   
 
  <table>
  <tr>
  <td> 
   <img  src="http://img6a.flixcart.com/image/book/7/7/4/my-jumbo-book-of-fairy-tales-400x400-imadwgbbhtgwprm2.jpeg" style="width:240px;height:360px" />
  </td>
...
<br>
  ...
  <p><span style="font-size:36px;font-family: 'Nunito', sans-serif;">  Our Price:</span><span style="font-size: 36px;font-family: 'Peralta', cursive;">Rs.170</span></p>
 <p><span style="font-size:20px;font-family:'Nunito'">  List Price:</span><span style="font-size: 20px;font-family:'Nunito';text-decoration:line-through">Rs.200</span></p>
...
<h2 style= "font-family: 'Nunito', sans-serif;">DESCRIPTION</h2>
  <p style= "font-family: 'Nunito', sans-serif;" >My Jumbo Book of Fairy Tales brings classic tales into the lives of children. They truly gorgeous illustrations add an extra element of classical style to these four stories.
  </p>
