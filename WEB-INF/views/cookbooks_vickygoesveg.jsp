...
<title>www.bookart.com/kids/vicky_goes_veg</title>
<meta charset="utf-8">
...
<p style="font-family: 'Nunito', sans-serif;color:blue"><a href="CookBooksPage"><u>Cookbooks</u></a>>>Vicky Goes Veg-Vicky Ratnani</p>

 <br>
<br>
  
  <h2 style="font-family: 'Oleo Script Swash Caps', cursive;">Vicky Goes Veg by Vicky Ratnani</h2>   
 
  <table>
  <tr>
  <td> 
   <img  src="http://ecx.images-amazon.com/images/I/51hcjhHj68L._SX383_BO1,204,203,200_.jpg" style="width:240px;height:360px" />
  </td>
...
<br>
  ...
  <p><span style="font-size:36px;font-family: 'Nunito', sans-serif;">  Our Price:</span><span style="font-size: 36px;font-family: 'Peralta', cursive;">Rs.700</span></p>
 <p><span style="font-size:20px;font-family:'Nunito'">  List Price:</span><span style="font-size: 20px;font-family:'Nunito';text-decoration:line-through">Rs.799</span></p>
  ...
  <p><a href="CookBooksPage"><button type="button" class="btn btn-info btn-md">BACK</button></a></p>
  </div>
  </td>
  </tr>
  </table>
...
<br>
  ...
  <p style= "font-family: 'Nunito', sans-serif;" > Spiced with handy tips and reflections on various recipes from the man himself, Vicky Ratnani, this book is green and fresh. The recipes here are not the boring ones we know. They hail from all over the world but have an Indian twist, braised plantain with Thai spices, hing-roasted pumpkin, vegetable Shepherd's pie and so on. Vicky's recipes are written clearly and made even more mouth-watering with a delicious series of photographs on the side. Filled with tips and trivia about herbs, recipes and that special ingredient, this book will have you rushing to the kitchen and add spark to your vegetarian cooking.</p>
