...
<title>www.bookart.com/fiction/harry_potter_and_the_prisoner_of_azkzban</title>
...
<p style="font-family: 'Nunito', sans-serif;color:blue"><a href="FictionPage"><u>Fiction</u></a>>>Harry Potter and the Prisoner of Azkaban</p> <p style="color:whitesmoke">acd</p>
   
<br>
<br>
  
  <h2 style="font-family: 'Oleo Script Swash Caps', cursive;"> Harry Potter and the Prisoner of Azkaban</h2>   
 
 <table>
  <tr>
  <td>
   <img  src="http://media.harrypotter.bloomsbury.com/rep/s/9781408855676_309040.jpeg" style="width:240px;height:360px" />
  </td>
...
<br>
  ...
  <p style= "font-family: 'Nunito', sans-serif;" >Harry Potter and the Prisoner of Azkaban is the third novel in the Harry Potter series, written by J. K. Rowling. The book follows Harry Potter, a young wizard, in his third year at Hogwarts School of Witchcraft and Wizardry. Along with friends Ron Weasley and Hermione Granger, Harry investigates Sirius Black, an escaped prisoner from Azkaban who they believe is one of Lord Voldemort's old allies</p>
