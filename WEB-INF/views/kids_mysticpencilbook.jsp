...
<title>www.bookart.com/kids/mystic_pencil_book</title>
<meta charset="utf-8">
...
<p style="font-family: 'Nunito', sans-serif;color:blue"><a href="KidsPage"><u>Kids</u></a>>>Mystic Pencil Book </p>

  <br>
    <br>
  
  <h2 style="font-family: 'Oleo Script Swash Caps', cursive;"> Mystic Pencil Book </h2>   
 
  <table>
  <tr>
  <td> 
   <img  src="https://ak0.scstatic.net/1/cdn2-cont13.sweetcouch.com/1273427-mystic-pencil-book.jpg"  />
  </td>
  ...
  <p><span style="font-size:36px;font-family: 'Nunito', sans-serif;">  Our Price:</span><span style="font-size: 36px;font-family: 'Peralta', cursive;">Rs.50</span></p>
 <p><span style="font-size:20px;font-family:'Nunito'">  List Price:</span><span style="font-size: 20px;font-family:'Nunito';text-decoration:line-through">Rs.59</span></p>
  ...
  <p style= "font-family: 'Nunito', sans-serif;" >Mystic Pencil Book is for tiny tots who enjoy colouring pictures with pencil colours</p>
    <br>
    <br>
