...
<title>www.bookart.com/fiction/harry_potter_and_the_order_of_the_phoenix</title>
...
<link rel="stylesheet" href="http://www.w3schools.com/lib/w3.css">
 <link rel="stylesheet" type="text/css"
   ...
   <link href='https://fonts.googleapis.com/css?family=Nunito|Pacifico|Yesteryear|Oleo+Script+Swash+Caps|Peralta' rel='stylesheet' type='text/css'>
...
<p style="font-family: 'Nunito', sans-serif;color:blue"><a href="FictionPage"><u>Fiction</u></a>>>Harry Potter and the Order of Phoenix</p> <p style="color:whitesmoke">acd</p>
  
   <br>
 <br>
  
  <h2 style="font-family: 'Oleo Script Swash Caps', cursive;"> Harry Potter and the Order of the Phoenix </h2>   
  
   <table>
  <tr>
  <td>
   <img  src="http://media.bloomsbury.com/rep/bj/9781408855690.jpeg" style="width:240px;height:360px" />
  </td>
 ...
 <br>
  ...
  <p><span style="font-size:36px;font-family: 'Nunito', sans-serif;">Our Price:</span><span style="font-size: 36px;font-family: 'Peralta', cursive;">Rs.450</span></p>
 <p><span style="font-size:20px;font-family:'Nunito'">List Price:</span><span style="font-size: 20px;font-family:'Nunito';text-decoration:line-through">Rs.799</span>
 ...
 <!-- <p><button type="button" class="btn btn-success btn-lg">BUY NOW</button></p>-->
  ...
  <p><a href="FictionPage"><button type="button" class="btn btn-info btn-md">BACK</button></a></p>
  </div>
 ...
 <br>
  ...
  <p style= "font-family: 'Nunito', sans-serif;" >Harry Potter and the Order of the Phoenix is the fifth novel in the Harry Potter series, written by J. K. Rowling. It follows Harry Potter's struggles through his fifth year at Hogwarts School of Witchcraft and Wizardry, including the surreptitious return of the antagonist Lord Voldemort, O.W.L. exams, and an obstructive Ministry of Magic.Harry Potter and the Order of the Phoenix is the fifth novel in the Harry Potter series, written by J. K. Rowling. It follows Harry Potter's struggles through his fifth year at Hogwarts School of Witchcraft and Wizardry, including the surreptitious return of the antagonist Lord Voldemort, O.W.L. exams, and an obstructive Ministry of Magic.</p>
...
<div class="specification">
   ...
   <h2 style= "font-family: 'Nunito', sans-serif;">SPECIFICATIONS OF THE BOOK</h2>
  ...
  <tr>
  <td>Publishers</td>
  <td>Bloomsbury Publishing (IN)</td>
  </tr>
  <tr>
