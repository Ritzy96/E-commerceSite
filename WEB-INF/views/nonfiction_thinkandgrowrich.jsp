...
<title>www.bookart.com/non-fiction/think_and_grow_rich</title>
...
<p style="font-family: 'Nunito', sans-serif;color:blue"><a href="NonFictionPage"><u>Non-Fiction</u></a>>>Think and Grow Rich- Napolean Hill</p>
 
  <br>
<br>
  
  <h2 style="font-family: 'Oleo Script Swash Caps', cursive;"> Think and Grow Rich by Napolean Hill. </h2>   
  
   <table>
  <tr>
  <td>
   <img  src="http://ecx.images-amazon.com/images/I/51xTBVE5KjL._SX317_BO1,204,203,200_.jpg" style="width:240px;height:360px" />
  </td>
...
<br>
  ...
  <p><span style="font-size:36px;font-family: 'Nunito', sans-serif;">Our Price:</span><span style="font-size: 36px;font-family: 'Peralta', cursive;">Rs.149</span></p>
 <p><span style="font-size:20px;font-family:'Nunito'">List Price:</span><span style="font-size: 20px;font-family:'Nunito';text-decoration:line-through">Rs.199</span>
...
<br>
  ...
  <p style= "font-family: 'Nunito', sans-serif;" ><p style= "font-family: 'Nunito', sans-serif;" >Think and Grow Rich was written in 1937 by Napoleon Hill, promoted as a personal development and self-improvement book. Hill writes that he was inspired by a suggestion from business magnate and (later) philanthropist Andrew Carnegie. While the book's title and much of the text concerns increased income, the author insists that the philosophy taught in the book can help people succeed in any line of work, to do and be anything they can imagine.</p>
