...
<title>www.bookart.com/fiction/harry_potter_and_the_chamber_of_secrets</title>
...
<link rel="stylesheet" href="http://www.w3schools.com/lib/w3.css">
 ...
 <link rel="stylesheet" type="text/css"
   ...
   <link href='https://fonts.googleapis.com/css?family=Nunito|Pacifico|Yesteryear|Oleo+Script+Swash+Caps|Peralta|family=Joti+One&effect=shadow-multiple|3d-float' rel='stylesheet' type='text/css'>
...
<p style="font-family: 'Nunito', sans-serif;color:blue"><a href="FictionPage"><u>Fiction</u></a>>>Harry Potter and the Chamber Of Secrets</p> 
  <br>
  <br>
  
  <h2 style="font-family: 'Oleo Script Swash Caps', cursive;"> Harry Potter and the Chamber Of Secrets</h2> 
    
 
   <table>
  <tr>
  <td> 
   <img  src="http://media.bloomsbury.com/rep/bj/9781408855904.jpeg" style="width:240px;height:360px" />
  </td>
 ...
 <p><span style="font-size:20px;font-family:'Nunito'">List Price:</span><span style="font-size: 20px;font-family:'Nunito';text-decoration:line-through">Rs.799</span>
  ...
  <p style= "font-family: 'Nunito', sans-serif;" >Harry Potter and the Chamber of Secrets is the second novel in the Harry Potter series, written by J. K. Rowling. The plot follows Harry's second year at Hogwarts School of Witchcraft and Wizardry, during which a series of messages on the walls of the school's corridors warn that the "Chamber of Secrets" has been opened and that the "heir of Slytherin" would kill all pupils who do not come from all-magical families. These threats are found after attacks which leave residents of the school "petrified" (frozen like stone). Throughout the year, Harry and his friends Ron Weasley and Hermione Granger investigate the attacks.</p>
