...
<title>www.bookart.com/kids/flavours_first</title>
<meta charset="utf-8">
...
<p style="font-family: 'Nunito', sans-serif;color:blue"><a href="CookBooksPage"><u>Cookbooks</u></a>>>Flavours First-Vikas Khanna</p>

   <br>
   <br>
  
  <h2 style="font-family: 'Oleo Script Swash Caps', cursive;"> Flavours First by Vikas Khanna</h2>   
 
  <table>
  <tr>
  <td> 
   <img  src="http://ecx.images-amazon.com/images/I/91j0WvwtwQL.jpg" style="width:240px;height:360px" />
  </td>
  ...
  <p><span style="font-size:36px;font-family: 'Nunito', sans-serif;">  Our Price:</span><span style="font-size: 36px;font-family: 'Peralta', cursive;">Rs.800</span></p>
 <p><span style="font-size:20px;font-family:'Nunito'">  List Price:</span><span style="font-size: 20px;font-family:'Nunito';text-decoration:line-through">Rs.995</span></p>
