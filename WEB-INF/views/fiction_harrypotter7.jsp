...
<title>www.bookart.com/fiction/harry_potter_and_the_deathly_hallows</title>
...
<p style="font-family: 'Nunito', sans-serif;color:blue"><a href="FictionPage"><u>Fiction</u></a>>>Harry Potter and the Deathly Hallows</p> <p style="color:whitesmoke">acd</p>
  
  <br>
 <br>
  
  <h2 style="font-family: 'Oleo Script Swash Caps', cursive;"> Harry Potter and the Deathly Hallows  </h2>   
 
   <table>
  <tr>
  <td>
   <img  src="http://media.harrypotter.bloomsbury.com/rep/s/9781408855713_309030.jpeg" style="width:240px;height:360px" />
 </td>
 ...
 <br>
  ...
  <p style= "font-family: 'Nunito', sans-serif;" >Harry Potter and the Deathly Hallows is the seventh and final novel of the Harry Potter series, written by British author J. K. Rowling. The novel chronicles the events directly following Harry Potter and the Half-Blood Prince (2005), and the final confrontation between the wizards Harry Potter and Lord Voldemort, as well as revealing the previously concealed back story of several main characters. The title of the book refers to three mythical objects featured in the story, collectively known as the "Deathly Hallows"-an unbeatable wand, a stone to bring the dead to life, and a cloak of invisibility</p>
