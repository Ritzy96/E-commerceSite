...
<title>www.bookart.com/fiction/harry_potter_and_the_half_blood_prince</title>
...
<p style="font-family: 'Nunito', sans-serif;color:blue"><a href="FictionPage"><u>Fiction</u></a>>>Harry Potter and the Half-blood Prince</p> <p style="color:whitesmoke">acd</p>
  
    
 <br>
 <br>
  
  <h2 style="font-family: 'Oleo Script Swash Caps', cursive;"> Harry Potter and the Half-Blood Prince </h2>   
  
   <table>
  <tr>
  <td>
   <img  src="http://media.harrypotter.bloomsbury.com/rep/s/9781408855706_309035.jpeg" style="width:240px;height:360px" />
  </td>
 ...
 <br>
  ...
  <p style= "font-family: 'Nunito', sans-serif;" >Harry Potter and the Half-Blood Prince is the sixth and penultimate novel in the Harry Potter series, written by British author J. K. Rowling. Set during protagonist Harry Potter's sixth year at Hogwarts, the novel explores the past of Harry's nemesis, Lord Voldemort, and Harry's preparations for the final battle against Voldemort alongside his headmaster and mentor Albus Dumbledore.</p>
