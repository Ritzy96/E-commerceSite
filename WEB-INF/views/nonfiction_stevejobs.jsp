...
<title>www.bookart.com/non-fiction/steve_jobs</title>
...
<p style="font-family: 'Nunito', sans-serif;color:blue"><a href="NonFictionPage"><u>Non-Fiction</u></a>>>Steve Jobs - Walter Issacson</p>
 

   <br>
<br>
  
  <h2 style="font-family: 'Oleo Script Swash Caps', cursive;"> Steve Jobs by Walter Issacson. </h2>   
  
   <table>
  <tr>
  <td>
   <img  src="https://upload.wikimedia.org/wikipedia/en/e/e4/Steve_Jobs_by_Walter_Isaacson.jpg" style="width:240px;height:360px" />
  </td>
...
<br>
  ...
  <p><span style="font-size:36px;font-family: 'Nunito', sans-serif;">Our Price:</span><span style="font-size: 36px;font-family: 'Peralta', cursive;">Rs.350</span></p>
 <p><span style="font-size:20px;font-family:'Nunito'">List Price:</span><span style="font-size: 20px;font-family:'Nunito';text-decoration:line-through">Rs.550</span>
...
<br>
  ...
  <p style= "font-family: 'Nunito', sans-serif;" >In Steve Jobs: The Exclusive Biography, Isaacson provides an extraordinary account of Jobs' professional and personal life. Drawn from three years of exclusive and unprecedented interviews Isaacson has conducted with Jobs as well as extensive interviews with Jobs' family members and key colleagues from Apple and its competitors, Steve Jobs: The Exclusive Biography is the definitive portrait of the greatest innovator of his generation. </p>
