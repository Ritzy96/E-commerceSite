...
<title>www.bookart.com/non-fiction/the_secret</title>
...
<p style="font-family: 'Nunito', sans-serif;color:blue"><a href="NonFictionPage"><u>Non-Fiction</u></a>>>The Secret-Rhonda Bryne</p>
 

  <br>
<br>
  
  <h2 style="font-family: 'Oleo Script Swash Caps', cursive;"> The Secret by Rhonda Bryne. </h2>   
  
   <table>
  <tr>
  <td>
   <img  src="https://upload.wikimedia.org/wikipedia/en/0/02/TheSecretLogo.jpg" style="width:240px;height:360px" />
  </td>
...
<br>
  ...
  <p><span style="font-size:36px;font-family: 'Nunito', sans-serif;">Our Price:</span><span style="font-size: 36px;font-family: 'Peralta', cursive;">Rs.490</span></p>
 <p><span style="font-size:20px;font-family:'Nunito'">List Price:</span><span style="font-size: 20px;font-family:'Nunito';text-decoration:line-through">Rs.750</span>
  ...
  <p><a href="NonFictionPage"><button type="button" class="btn btn-info btn-md">BACK</button></a></p>
  </div>
  </td>
  </tr>
  </table>
...
<br>
  ...
  <p style= "font-family: 'Nunito', sans-serif;" >Fragments of a Great Secret have been found in the oral traditions, in literature, in religions and philosophies throughout the centuries. For the first time, all the pieces of The Secret come together in an incredible revelation that will be life-transforming for all who experience it.
In this book, you'll learn how to use The Secret in every aspect of your life -- money, health, relationships, happiness, and in every interaction you have in the world. </p>
