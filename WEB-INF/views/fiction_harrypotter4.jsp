...
<title>www.bookart.com/fiction/harry_potter_and_the_goblet_of_fire</title>
...
<p style="font-family: 'Nunito', sans-serif;color:blue"><a href="FictionPage"><u>Fiction</u></a>>>Harry Potter and the Goblet of Fire </p> <p style="color:whitesmoke">acd</p>
  <br>
 <br>
  
  <h2 style="font-family: 'Oleo Script Swash Caps', cursive;"> Harry Potter and the Goblet of Fire </h2>   
  
  <table>
  <tr>
  <td>
   <img  src="http://media.bloomsbury.com/rep/bj/9781408855683.jpeg" style="width:240px;height:360px" />
  </td>
 ...
 <br>
  ...
  <p style= "font-family: 'Nunito', sans-serif;" >Harry Potter and the Goblet of Fire is the fourth novel in the Harry Potter series, written by British author J. K. Rowling. It follows Harry Potter, a wizard in his fourth year at Hogwarts School of Witchcraft and Wizardry and the mystery surrounding the entry of Harry's name into the Triwizard Tournament, in which he is forced to compete</p>
